...
//            shivam code changes for adding header button on product.template tree view

            var a_id = this.action.xml_id;
            view_controller.renderButtons($buttons ? $buttons.empty() : elements.$buttons, a_id);
//            shivam end
