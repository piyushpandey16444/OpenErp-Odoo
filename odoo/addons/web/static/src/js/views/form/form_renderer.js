...
var FormRenderer = BasicRenderer.extend({
    ...
    events: _.extend({}, BasicRenderer.prototype.events, {
        ...
        // Devashish code 20 March 2020 | For removing cache
        'click .o_input': '_makeid',
        'click .ui-autocomplete-input': '_makeidautocomplete',
        // End
    }),
    /**
     * @override
    ...
    */
    ...
    // Devashish code 20 March 2020 | This code for header static in all table which comes on tabs
    _makeid: function(){
        console.log("Input box has been clicked ............................................................ 2020.");
        var length           = 5;
        ...
        $(".o_input").attr('autocomplete','new-password');
        $(".o_input").removeAttr("name_1", result);
        $(".o_input").attr("name_1", result);
    },

    _makeidautocomplete: function(){
        console.log("Input box has been clicked ............................................................ 2021.");
        setTimeout(function(){
            $('.o_group').disableAutoFill();
            $('.o_form_view').disableAutoFill();
            $('.o_list_view').disableAutoFill();
            $('.o_input_dropdown').disableAutoFill();
        },200);
        $('.o_group').disableAutoFill();
        $('.o_form_view').disableAutoFill();
        $('.o_list_view').disableAutoFill();
