...
class ResConfigSettings(models.TransientModel):
    ...
    # Aman 5/08/2020 Commented this field because it is not required(functionality is running internally)
    # default_options_stock = fields.Selection([
    #     ('stock_sales_order', 'Stock up through Sales Order'),
    #     ('xyz', 'Stock up through Manufacturing'),
    # ], string='Stock Options', default_model="sale.order", default='xyz')
    # Aman end
