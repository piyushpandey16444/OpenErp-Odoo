...
class Company(models.Model):
    ...
    # Piyush: default positive stock field added negative and positive setting option 19-03-2020
    ...
    def create(self, vals):
        ...
        self.env['stock.warehouse'].sudo().create({'name': company.name, 'code': company.name[:5],
