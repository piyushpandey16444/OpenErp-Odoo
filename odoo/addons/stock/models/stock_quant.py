...
class StockQuant(models.Model):
    ...
    # Piyush: reserved qty 18-03-2020
    # def quantity_in_stock(self):
    #     for val in self:
    #         lines = self.env['stock.move'].search(
    #             [('product_id', '=', self.product_id.id), ('origin', '=', self.origin)])
    #         if lines:
    #             quantity_done = val.quantity_done
    #             if quantity_done > self.reserved_quantity:
        ...
        for quant in quants:
            try:
                with self._cr.savepoint():
                    ...
                    print("selfffvvvvvvvv stock move line,", self)
                    quant.write({
