...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    @api.multi
    def execute(self):
        # Avinash 06/11/2020 Commented and Added Validation to check Lot Sequence Generator field
        # Aman 17/10/2020 Validation to check Lot Sequence Generator field
        # if self.group_stock_production_lot == True and self.module_stock_ext == False:
        #     raise UserError(_("You can not Uncheck Lot Sequence Generator field!!"))
        # Aman end
        if self.group_stock_production_lot == True and self.module_sequence_generator == False:
            raise UserError(_("You can not Uncheck Lot Sequence Generator field!!"))
        # end avinash
        self.ensure_one()
