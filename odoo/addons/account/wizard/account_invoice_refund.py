    ...
    def compute_refund(self, mode='refund'):
        ...
        for form in self:
            ...
            for inv in inv_obj.browse(context.get('active_ids')):
                ...
                # Aman 17/10/2020 added code to get order_calculation_ids and display it in the table
                order_calc_ids = self.env['order.calculation.invoice'].search([('invoice_id', '=', inv.id)])
                refund.order_calculation_ids = order_calc_ids
                # Aman end
