...
class ResConfigSettings(models.TransientModel):
    ...
    # avinash:18/08/20 So that sale can be done in cash invoice

    default_setting_cash_invoice = fields.Boolean(default_model="account.invoice", string="Cash Invoice", help="Cash invoice can only be made if this field is checked.")
    ...
    default_stock_invoice = fields.Boolean( string='Stock Up- Vendor Bills',
