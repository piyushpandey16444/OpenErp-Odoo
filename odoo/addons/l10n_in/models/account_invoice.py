...
class AccountInvoice(models.Model):
    ...
    # Yash - 20/11/2020 : START add tax in words in account invoice report
    ...
    # Yash - 20/11/2020 : END add tax in words in account invoice report

    amount_total_words = fields.Char("Total (In Words)", compute="_compute_amount_total_words")
    # Yash - 20/11/2020 : Add tax in words in account invoice report
    amount_tax_words = fields.Char("Tax (In Words)", compute="_compute_amount_tax_words")
